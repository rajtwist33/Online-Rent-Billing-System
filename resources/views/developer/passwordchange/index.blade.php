...
@section('main-body')
      ...
      <div class="card card-primary">
        ...
        <h3 class="card-title">Update Developer Password</h3>
        </div>
        <form action="{{route('developer.password_change.store')}}" method="post" enctype="multipart/form-data">
            @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="account" value="{{$data->account}}" id="exampleInputPassword1" placeholder="Enter User Id">
                    </div>
                ...
                <div class="form-group">
                        <input type="hidden" class="form-control" name="data_id" value="{{$data->id}}" id="exampleInputPassword1" placeholder="Enter User Id">
                    </div>
                </div>
                <div class="col-md-6">
